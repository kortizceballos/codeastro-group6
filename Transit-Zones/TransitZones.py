...
find_planets = 1                # finds all known planets which fall into transit zones -reproduces appendix 3
...
plot_comparison = 0             # plots comparison of a crossover region size - reproduces figure 4 in paper
                                ...
                                # requires find_crossovers = 1 to have been run three times with eq = 't', 'a' and 'g'
print_planet_params = 1         # outputs table of TZ & grazing angle, plus transit depths - reproduces table 1
...
#names = ['Mercury', 'Venus', 'Earth', 'Mars', 'Jupiter', 'Ganymede', 'Saturn', 'Uranus', 'Neptune']     # names of planets
names = ['Earth', 'Moon', 'Jupiter', 'Ganymede', 'Saturn', 'Titan']     # names of planets
#names = ['Moon', 'Ganymede']     # names of planets
#radii = [2.4397E3, 6.0518E3, 6.3710E3, 3.3895E3, 6.9911E4, 2.684E3, 5.8232E4, 2.5362E4, 2.4622E4]    # radii of planets
radii = [6.3710E3, 1.7374E3, 6.9911E4, 2.684E3, 5.8232E4, 2.575E3]    # radii of planets
#radii = [1.7374E3, 2.684E3]    # radii of planets
#s_d = [57.909227E6, 1.0820948E8, 1.4959826E8, 2.2794382E8, 7.7834082E8, 7.7834082E8, 1.4266664E9, 2.8706582E9, 4.4983964E9] # semimajor axis
s_d = [1.4959826E8, 1.4959826E8, 7.7834082E8, 7.7834082E8, 1.4266664E9, 1.4266664E9] # semimajor axis
#s_d = [1.4959826E8, 7.7834082E8] # semimajor axis
